 <header class="main-header">
    ...
    <?php $logo = "logo_besar.png" ?>
    <a href="#" class="logo" style="background-color: #367FA9;">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini" style="background: #367FA9;">
        
        <span style="color:black">KTRAVEL KOPKAR</span>
      </span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style="background: #367FA9;">
    ...
    <nav class="navbar navbar-static-top" style="background: darkslategrey;">
