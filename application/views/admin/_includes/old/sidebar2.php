...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li <?=$this->uri->segment(1) == 'Lupaemail_controller' ? 'class="active"' : '' ?>>
        <a href="<?php echo base_url('Lupaemail_controller') ?>"><i class="fa fa-fw fa-file"></i> <span>Lupa Email</span></a>
      </li>
      ...
      <li <?=$this->uri->segment(1) == 'Pembiayaan_controller' ? 'class="active"' : '' ?>>
        <a href="<?php echo base_url('Pembiayaan_controller') ?>"><i class="fa fa-fw fa-file"></i> <span>Pembiayaan</span></a>
      </li>
    <?php
