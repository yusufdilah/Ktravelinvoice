...
<div class="login-box">
	<div class="login-logo">
		<a href="<?php echo base_url('Auth')?>"><b>Admin Ktravel</b></a>
	</div>
	...
	<div class="login-box-body">
		...
		<form action="<?php echo base_url('Auth/login')?>" method="post">
			...
			<!-- <div class="form-group">
				...
				<div class="radio">
					<label>
						<input type="radio" class="<?php echo form_error('level') ? 'is-invalid':'' ?>" name="level" value="Admin" checked="">
						Admin
					</label>
				</div>
				<div class="radio">
					<label>
						<input type="radio" class="<?php echo form_error('level') ? 'is-invalid':'' ?>" name="level" value="User">
						User
					</label>
				</div>
			</div> -->
