...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <a href="<?php echo site_url('Helpdesk_controller/list_answer')?>" class="btn btn-tosca"><i class="fa fa-fw fa-arrow-left"></i></a>
      <h1>
        Manage
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <small>Attachment :</small><br>
                  ...
                  <a target="_blank" href="<?=base_url($folder.$helpdesk->file_1)?>">
                   
                    <?php echo $helpdesk->file_1 ?>
                    
                  </a> <br>
                  <a target="_blank" href="<?=base_url($folder.$helpdesk->file_2)?>">
              ...
              <div class="box-body chat;  id="chat-box">
                <?php if($value->file_1 !='') {?> 
                        <div style="margin-bottom:5px;">
                          <img class="pull-left" src="<?=base_url($folder.$value->file_1)?>"  style="width: 88px;">
                        </div>  
                       <?php } 
                       else {?>
                            <div style="margin-bottom:5px;">
                ...
                <?php if($value->file_2 !='') {?> 
                        <div style="margin-bottom:5px;">
                          <img class="pull-left" src="<?=base_url($folder.$value->file_2)?>"  style="width: 88px;">
                        </div>  
                       <?php } 
                       else {?>
                            <div style="margin-bottom:5px;">
              ...
              <!-- <div class="item"> -->
                ...
                <p >
                  <a>
                    ...
                    <!-- <img class="pull-right" src="<?=base_url($folder.$value->file_1)?>"  style="width: 88px;">
                    <img class="pull-right" src="<?=base_url($folder.$value->file_2)?>"  style="width: 88px;">   -->
                  </a>
