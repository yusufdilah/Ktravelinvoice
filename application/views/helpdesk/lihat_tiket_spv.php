        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-success">
            <form role="form" action="<?php echo base_url('Helpdesk_controller/tambah_komentar_spv/'.$helpdesk->tiket_id) ?>" method="post" enctype="multipart/form-data"> 
              ...
              <div class="form-group">
                   <textarea class="form-control <?php echo form_error('jawaban') ? 'is-invalid':'' ?>" name="jawaban" id="jawaban" placeholder="Masukan Isi" required><?php echo $history_spv->jawaban ?></textarea>
              ...
              <div class="form-group">
                <label>Attach File</label><br>
                      <?php if($history_spv->file_1 !='') {?> 
                          <small>File 1 :</small><br>
                          <div style="margin-bottom:5px;">
                            <a target="_blank" href="<?=base_url($folder.$history_spv->file_1)?>">
                              <?php echo $history_spv->file_1 ?>
                            </a>
                            
                            <input class="form-control" src="<?=base_url($folder.$history_spv->file_1)?>" name="file_1_input" value="<?php echo $history_spv->file_1?>" type="hidden"  >
                            <input class="form-control" src="<?=base_url($folder.$history_spv->file_1)?>" name="file_1" value="<?php echo $history_spv->file_1?>" type="file"  >
                          </div> 
                       <?php } 
                       else {?>
                            <small>File 1 :</small><br>
              ...
              <div class="form-group">
                <?php if($history_spv->file_2 !='') {?> 
                        <small>File 2 :</small><br>
                        <div style="margin-bottom:5px;">
                          <a target="_blank" href="<?=base_url($folder.$history_spv->file_2)?>">
                            <?php echo $history_spv->file_2 ?>
                          </a>
                          <input class="form-control" src="<?=base_url($folder.$history_spv->file_2)?>" name="file_2_input" value="<?php echo $history_spv->file_2?>" type="hidden"  >
                          <input class="form-control" src="<?=base_url($folder.$history_spv->file_2)?>" name="file_2" value="<?php echo $history_spv->file_2?>" type="file"  >
                        </div>  
                       <?php } 
                       else {?>
                            <small>File 2 :</small><br>
