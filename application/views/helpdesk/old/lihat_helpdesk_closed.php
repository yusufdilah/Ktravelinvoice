              ...
              <div class="box">
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php $no = 1;?>
                      <?php foreach ($helpdesk_closed as $value): ?>
                        <tr>
                          <td><?php echo $no++; ?></td>
                          ...
                          <td>
                            ...
                            <a class="btn btn-ref" href="<?php echo site_url('Helpdesk_controller/lihat_tiket_closed/'.$value->tiket_id   ) ?>"><i class="fa fa-fw fa-eye"></i>Lihat</a>
