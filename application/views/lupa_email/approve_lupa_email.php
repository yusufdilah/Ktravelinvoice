    ...
    <section class="content-header">
      <h1>
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('Lupa_email_controller/index') ?>">List Data Lupa Email</a></li>
          <li>
              <a href="<?php echo base_url('Lupa_email_controller/index') ?>" class="btn btn-tosca"><i class="fa fa-fw fa-backward"></i></a>
          </li>
        </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('Lupa_email_controller/save/'.$lupa_email->lupa_email_id) ?>" method="post">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>NIP</label>
                  <input name="nip" class="form-control <?php echo form_error('nip') ? 'is-invalid':'' ?>" placeholder="Masukan link Youtube" value="<?php echo $lupa_email->nip?>" type="text" readonly/>
                  <div class="invalid-feedback">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  <!-- <label>Foto</label> -->
                  <input name="password" id="password" class="form-control <?php echo form_error('password') ? 'is-invalid':'' ?>" placeholder="Masukan Isi" value="<?php echo $lupa_email->password?>" type="hidden" readonly>
                </div>
                <div class="form-group">
                  <!-- <label>Foto</label> -->
                  <input name="foto" id="foto" class="form-control <?php echo form_error('foto') ? 'is-invalid':'' ?>" placeholder="Masukan Isi" value="<?php echo $lupa_email->foto?>" type="hidden" readonly>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('Lupa_email_controller/index') ?>" class="btn btn-info"><i class="fa fa-fw fa-arrow-left"></i>Cancel</a>
