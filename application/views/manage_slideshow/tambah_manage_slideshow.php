              ...
              <form role="form" action="<?php echo base_url('Manage_slideshow_controller/add/') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input name="info_terbaru_id" required="" class="form-control <?php echo form_error('info_terbaru_id') ? 'is-invalid':'' ?>"  type="hidden" value="<?php echo $info_terbaru->info_terbaru_id ?>" >
                    <input name="judul" required="" class="form-control <?php echo form_error('judul') ? 'is-invalid':'' ?>" placeholder="<?php echo $info_terbaru->judul ?>" type="text" value="<?php echo $info_terbaru->judul ?>" readonly>
                ...
                <div class="box-footer">
                  ...
                  <a href="<?php echo site_url('Info_terbaru_controller/detail/'.$info_terbaru->info_terbaru_id) ?>" class="btn btn-danger"><i class="fa fa-fw fa-times"></i>Batal</a>
