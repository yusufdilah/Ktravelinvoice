            ...
            <!-- form start -->
              ...
              <div class="box-footer">
               ...
               <a class="btn btn-ref" href="<?php echo site_url('Registrasi_controller/form_approval/'.$registrasi->registrasi_id) ?>"><i class="fa fa-fw fa-question"></i>Approve</a>
                ...
                <a href="<?php echo base_url('Registrasi_controller') ?>" class="btn btn-info"><i class="fa fa-fw fa-arrow-left"></i>Cancel</a>
              </div>
            <!-- </form> -->
          </div>
          <!-- /.box -->
...
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form  role="form" action="<?php echo base_url('Registrasi_controller/rejectNasabah/'.$registrasi->registrasi_id) ?>" method="post">   
      ...
      <div class="form-group">
            <div class="box-body">
                  ...
                  <input type="hidden" name="nama"  value="<?php echo $registrasi->nama?>" />       
                  <div class="form-group">
                          <label>Alasan ditolak</label> <br>
                          <textarea required="" name="alasan_ditolak" class="form-control" rows="4" cols="50" maxlength="255">
                          </textarea>
