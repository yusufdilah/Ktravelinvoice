    ...
    <div class="content-wrapper">
      ...
      <!-- Alert -->
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-fw fa-user-plus"></i> History Follow Up</a></li>
            <li><a href="#">List History Follow Up</a></li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <a href="<?php echo site_url('Reminder_controller')?>" class="btn btn-tosca"><i class="fa fa-fw fa-arrow-left"></i></a>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php $no = 1;?>
                      <?php foreach ($list_foll_up as $value): ?>
                        <tr>
                          <td><?php echo $no++; ?></td>
                          <td><?php echo $value->tgl_foll_up ?></td>
                          <td><?php echo $value->invoice_no?></td>
                          <td><?php echo $value->pic_invoice ?></td>
                          <td><?php echo $value->pic_foll_up ?></td>
                          
                          <td>
                            <!-- <a href="#!" onclick="editConfirm()" class="btn btn-ref"><i class="fa fa-fw fa-edit" title="Edit"></i></a> -->
                            <a data-toggle="modal" data-target="#modal-detail<?=$value->history_id;?>" class="btn btn-warning btn-circle" data-popup="tooltip" data-placement="top" title="Detail Follow Up"><i class="fa fa-info"></i></a>
...
<?php $no=0; foreach($list_foll_up as $value): $no++; ?>
<!-- <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"> -->
<div class="row">  
<div id="modal-detail<?=$value->history_id;?>" aria-hidden="true" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" class="modal fade">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <form  role="form" action="<?php echo base_url('Reminder_controller/add') ?>" method="post">   
      ...
      <input type="hidden" readonly value="<?=$value->history_id;?>" name="perusahaan_id" class="form-control" >
      <div class="form-group">
        <div class="box-body">
        ...
        <div class="box-body">
            ...
            <input readonly="" type="text" value="<?=$value->invoice_no;?>"  name="invoice_no" id="invoice_no" class="form-control" >
        </div>

        <div class="box-body">
          <label>PIC</label>
          <input name="pic" readonly="" type="text" value="<?=$value->pic_foll_up?>" class="form-control <?php echo form_error('pic') ? 'is-invalid':'' ?>" placeholder="Masukkan PIC" type="text"/>
          <div class="invalid-feedback">
        ...
        <div class="box-body">
          ...
          <textarea readonly=""  value="<?=$value->keterangan?>"  name="keterangan" class="form-control <?php echo form_error('keterangan') ? 'is-invalid':'' ?>" placeholder="Masukkan Keterangan" >
            <?php echo $value->keterangan?></textarea>
          <div class="invalid-feedback">
