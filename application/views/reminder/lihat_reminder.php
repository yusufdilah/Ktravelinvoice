      ...
      <!-- Alert -->
        ...
        <section class="content">
         <?php $jml_foll_up = $jml_foll_up;?>
          <button class="btn btn-ref"  name="submit" type="submit"><a style="color: black"  href="<?php echo base_url('Reminder_controller/list_foll_up') ?>"><i style="margin-left: -3px;" ></i>History Follow Up (<?php echo $jml_foll_up; ?>)</a></button>
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                      ...
                      <?php foreach ($reminder as $value): ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a data-toggle="modal" data-target="#modal-edit<?=$value->invoice_id;?>" class="btn btn-warning btn-circle" data-popup="tooltip" data-placement="top" title="Follow Up"><i class="fa fa-sticky-note"></i></a>
...
<div id="modal-edit<?=$value->invoice_id;?>" aria-hidden="true" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" class="modal fade">
  <div class="modal-dialog" role="document">
    ...
    <form  role="form" action="<?php echo base_url('Reminder_controller/add') ?>" method="post">   
      ...
      <input type="hidden" readonly value="<?=$value->invoice_id;?>" name="perusahaan_id" class="form-control" >
      <div class="form-group">
        <div class="box-body">
