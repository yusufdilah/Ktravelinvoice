    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('Setting_tiket_divisi_controller/add') ?>">Tambah Data Tiket Divisi</a></li>
        </ol>
      </section>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" action="<?php echo base_url('Setting_tiket_divisi_controller/add') ?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
