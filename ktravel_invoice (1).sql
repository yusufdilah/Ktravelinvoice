...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2021 at 05:34 PM
...
CREATE TABLE `invoice2` (
  ...
  `status` int(11) NOT NULL COMMENT '0 : Unprocess, 1 : Process, 2 : Paid, 3 : Overdue, 4 : Follow Up',
...
INSERT INTO `invoice2` (`id`, `no_invoice`, `perusahaan_id`, `pic_id`, `divisi_id`, `status`, `created_date`, `updated_date`, `created_by`, `updated_by`) VALUES
(31, '0001', 1, 12, 5, 1, '2021-12-29', '0000-00-00', '0010013589', ''),
(32, '0002', 3, 13, 9, 1, '2021-12-29', '0000-00-00', '0010013589', '');
...
(12, 'Voluptas quo at e', NULL, NULL, 5, 'Praesentium odio dig', 1, 'Rerum consequat', '0010013589', '2021-12-27 02:15:30', NULL, NULL),
(13, 'Iste duis porro i', NULL, NULL, 9, 'In esse exercitation', 1, 'Quo mollitia ut', '0010013589', '2021-12-27 02:15:34', '2021-12-27 02:15:45', '0010013589'),
(14, 'Non libero ea por', NULL, NULL, 5, 'Mollit vero porro re', 0, 'Itaque non dese', '0010013589', '2021-12-27 02:15:38', NULL, NULL);
...
CREATE TABLE `tiket` (
  ...
  `pic_tiket` varchar(255) DEFAULT NULL,
  `divisi` int(7) DEFAULT NULL,
  ...
  `no_memo` varchar(170) DEFAULT NULL,
  `hotel` varchar(150) DEFAULT NULL,
  `bookers` varchar(150) DEFAULT NULL,
  ...
  `status_tiket` int(1) DEFAULT NULL COMMENT '0 : Belum lunas 1 : Lunas',
  `created_date` datetime DEFAULT current_timestamp(),
  `created_by` varchar(15) DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `updated_by` varchar(15) DEFAULT NULL
...
INSERT INTO `tiket` (`tiket_id`, `tgl_berangkat`, `tgl_issued`, `pic_tiket`, `divisi`, `no_invoice`, `akomodasi`, `maskapai`, `customer`, `kode_booking`, `no_memo`, `hotel`, `bookers`, `alamat_hotel`, `route`, `vendor`, `hpp`, `service_fee`, `biaya_lain`, `harga_jual`, `status_tiket`, `created_date`, `created_by`, `updated_date`, `updated_by`) VALUES
(1, '2021-12-01', '2021-12-01', 'wdawddawd', 5, '0001', 5, 3, 6, 'BB012OI', 'aw21312', 'awdaw21343', 'adaw213s', 'aw1423 fadaw', 2, 6, 1223, 1231, 213, 123, 0, '2021-12-27 02:21:08', '0010013589', '2021-12-26 20:18:10', NULL),
(2, '2021-11-11', '2021-11-09', 'adawdawd', 9, '0002', 2, 3, 7, 'PO120EW', 'dawda323', '4234sf', 'awe23423', '234asdaw', 4, 6, 231, 122, 332, 12, 0, '2021-12-27 02:21:08', '0010013589', '2021-12-26 20:18:10', NULL),
(3, '2021-12-03', '2021-12-04', 'asdasd', 5, '0001', 1, 3, 8, 'KL9912E', 'awe34234', 'awda42423', 'aw23423', 'aw324234', 2, 6, 2323, 213, 1232, 123, 0, '2021-12-27 06:40:42', '0010013589', '2021-12-27 00:39:08', NULL);
...
--
-- AUTO_INCREMENT for table `invoice2`
--
ALTER TABLE `invoice2`
...
--
ALTER TABLE `pic`
  MODIFY `pic_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `tiket`
  MODIFY `tiket_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
